  ...
  return (
    <div className="about-page">
      ...
      <div className="about-collapses">
        ...
        <Collapse title="Service" content="La qualité du service est essentielle à notre engagement chez Kasa. Nous veillons à ce que chaque échange, qu’il soit entre hôtes ou locataires, se déroule dans un esprit de respect, de disponibilité et de bienveillance." />
        <Collapse title="Sécurité" content="La sécurité est une priorité absolue chez Kasa. Chaque logement respecte des critères stricts établis par nos équipes. En laissant une note, les voyageurs aident à garantir le maintien de ces standards. Nous proposons également des ateliers sur la sécurité domestique pour nos hôtes." />
      </div>
    </div>
  );
}
